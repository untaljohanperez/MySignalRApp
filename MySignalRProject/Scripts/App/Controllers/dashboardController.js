...
app.controller('DashboardController', ['$scope', 'backendHubProxy', function ($scope, backendHubProxy) {

        console.log('trying to connect to service');
        var dashboardHub = backendHubProxy('helloWorldHub');
        console.log('connected to service')
        
        dashboardHub.on('showMessage', function (message) {
